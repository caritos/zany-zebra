-- Migration: Remove redundant display_name and username fields
-- Date: 2025-09-25
-- Description: Simplify function to only return necessary fields

-- Drop the existing function
DROP FUNCTION IF EXISTS get_club_members_with_ratings(BIGINT);

-- Create simplified function with only necessary fields
...
BEGIN
  ...
  SELECT
    club_users.user_id,
    profiles.email,
    profiles.email, -- Keep for compatibility but same as email
    NULL::TEXT, -- username not needed, return NULL
    profiles.nickname,
