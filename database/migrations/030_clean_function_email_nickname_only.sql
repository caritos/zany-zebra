-- Migration: Clean function with only email and nickname
-- Date: 2025-09-25
-- Description: Simplified function returning only email and nickname (no display_name or username)

-- Drop the existing function
DROP FUNCTION IF EXISTS get_club_members_with_ratings(BIGINT);

-- Create clean function with only email and nickname
