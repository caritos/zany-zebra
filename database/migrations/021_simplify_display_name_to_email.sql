-- Migration: Simplify display_name to just use email directly
-- Date: 2025-09-25
-- Description: Remove confusing display_name alias and just use email directly

-- Drop the existing function
DROP FUNCTION IF EXISTS get_club_members_with_ratings(BIGINT);

-- Create updated function that uses email directly (no display_name alias)
